...
export default function ThemeToggle() {
    ...
    return (
        <button 
            className='relative flex items-center gap-6 bg-sky-950 px-3 py-2 rounded-full border border-transparent hover:border-sky-800 active:bg-sky-800'
            onClick={handleClick}
        >
...
function SelectedModeIcon({theme} : {theme : Theme}) {
    return (
        <span className={`
            ...
            bg-sky-800 transition-all duration-200
        `} />
    )
}
